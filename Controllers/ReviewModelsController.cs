...
using review_box.Models;

namespace review_box.Controllers
{
    public class ReviewModelsController : Controller
    {
        private review_boxContext db = new review_boxContext();
        ...
        public ActionResult Create([Bind(Include = "RecordNum,Topic,Suggestion")] ReviewModel reviewModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RecordNum,Topic,Suggestion")] ReviewModel reviewModel)
        {
            if (ModelState.IsValid)
            {
